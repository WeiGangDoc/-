 ...
 * 文件名:		mu_usart.h
 * 功能:		读取DS18B20温度数据
 * 引脚:PA9--TX1	PA10--RX1	PA2--TX2	PA3--RX2
*************************************************************************************************************/
/************************************************************************************************************
使用方法:	
在main.h中添加代码
...
float MAX44009_lux;
MAX44009_Init(&hi2c2);
while(MAX44009_ContinuousMode(1) !=MAX44009_OK)
{
	printf("MAX44009 init Error\r\n");
	delay_ms(100);
}printf("MAX44009 init OK\r\n");

	MAX44009_ReadLightHighResolution(&MAX44009_lux);
	printf("lux = %f\r\n",MAX44009_lux);
*************************************************************************************************************/
